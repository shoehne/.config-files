...
rm -rfv $HOME/.config/elephant
rm -rfv $HOME/.config/walker
rm -rfv $HOME/.config/wireplumber
rm -rfv $HOME/.config/pipewire
rm -rfv $HOME/.config/mako
rm -rfv $HOME/.config/firejail
rm -rfv $HOME/.config/nwg-bar

# sudo mkdir -p /etc/greetd/ && sudo cp -u $PWD/greetd/* /etc/greetd/
...
ln -s $PWD/elephant $HOME/.config/elephant
ln -s $PWD/walker $HOME/.config/walker
ln -s $PWD/wireplumber $HOME/.config/wireplumber
ln -s $PWD/pipewire $HOME/.config/pipewire
ln -s $PWD/mako $HOME/.config/mako
ln -s $PWD/nwg-bar $HOME/.config/nwg-bar
ln -s $PWD/firejail $HOME/.config/firejail
